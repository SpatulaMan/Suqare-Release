	...
	{ 
		...
		switch(room)
		{
			...
			case r_lvl_30:
			{
				...
				else if(o_lvl30.o1 and o_lvl30.o2 and o_lvl30.o3 and !instance_exists(o_carSt))
				{
					obj_suq.report = 91;
					obj_suq.hiertech -= 4;
					o_saveload.hnet -= 15;
				...
				else if(!instance_exists(o_carSt))
				{
					obj_suq.report = 90;
					obj_suq.ungulate += 1;
					obj_suq.hiertech -= 2;
			...
			case r_lvl_34:
			{
				...
				o_saveload.unet -= 2;
				o_saveload.hnet += 3;
				if(o_lvl34.o1 and o_lvl34.tirH < 2)
				{
					obj_suq.report = 108;
					o_saveload.gnet += 10;
					o_saveload.ynet -= 6;
					...
					{ 
						...
						obj_suq.tempEarnMon = 7700-o_lvl34.nod;
					}
					else
					{
				...
				else if(o_lvl34.o2 and o_lvl34.tirH < 2)
				{
					o_saveload.ynet -= 6;
					o_saveload.gnet += 7;
					obj_suq.report = 109;
					...
					{ 
						...
						obj_suq.tempEarnMon = 2500-o_lvl34.nod;
					}
					else
					{
						obj_suq.tempEarnMon = 0;
				...
				else if(o_lvl34.o1 and o_lvl34.tirH >= 2)
				{
					obj_suq.report = 111;
					o_saveload.gnet += 10;
					o_saveload.ynet -= 6;
				...
				else if(!o_lvl34.o1 and !o_lvl34.o2 and o_lvl34.tirH < 2)
				{
					o_saveload.ynet += 5;
					o_saveload.gnet -= 8;
					obj_suq.report = 110;
			...
			case r_lvl_44:
			{
				...
				o_saveload.hnet -= 3;
				o_saveload.ynet -= 3;
				if(o_lvl44.o1 and o_lvl44.o2 and o_lvl44.o3 and o_lvl44.tirH >= 1)
				{
					obj_suq.report = 113;
					o_saveload.gnet += 12;
					obj_suq.gildebrand += 3;
					o_saveload.moneyT += 9500;
					o_saveload.success++;
				}
				else if(o_lvl44.o1 and o_lvl44.o2 and o_lvl44.o3 and o_lvl44.tirH < 1)
				{
					obj_suq.report = 117;
					o_saveload.gnet += 10;
					obj_suq.gildebrand += 2;
				...
				else if((o_lvl44.o1 or o_lvl44.o2 or o_lvl44.o3) and o_lvl44.tirH >= 1)
				{
					obj_suq.report = 114;
					o_saveload.gnet += 7;
					obj_suq.gildebrand += 2;
					o_saveload.moneyT += 5500;
					o_saveload.success++;
				}
				else if((o_lvl44.o1 or o_lvl44.o2 or o_lvl44.o3) and o_lvl44.tirH < 1)
				{
			...
			case r_lvl_35:
			{
				...
				else if(o_lvl35.o1 == true and o_lvl35.o2 == false)
				{
					randomize();
