...
function scr_sellback(_i,_ch)
{
	...
	/*repeat(42)
	{
		...
		else
		{
			switch(s)
			{
				case 5: obj_suq.money += (_i.p[s] * obj_suq.minegAmt/3); break;
				case 6: obj_suq.money += (_i.p[s] * obj_suq.minesAmt/3); break;
				case 7: obj_suq.money += (_i.p[s] * obj_suq.lock30/3); break;
				case 8: obj_suq.money += (_i.p[s] * obj_suq.lock50); break;
				case 28: obj_suq.money += (_i.p[s] * obj_suq.attackTur); break;
				case 29: obj_suq.money += (_i.p[s] * obj_suq.defenseTur); break;
				case 30: obj_suq.money += (_i.p[s] * obj_suq.tearTur); break;
				case 31: obj_suq.money += (_i.p[s] * obj_suq.flameTur); break;
				case 32: obj_suq.money += (_i.p[s] * obj_suq.rocketTur); break;
			}
			s++;
		}
	}*/
	...
	obj_suq.arda = 8; obj_suq.armr = 60;
