...
switch(room)
{
	...
	case r_lvl_33: t = 177; o1 = 180; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl33.o1) { obj1 = true; } break;
	
	case r_lvl_34: t = 194; o1 = 197; o2 = 198; b = scr_briefing(t); ot1 = scr_briefing(o1); ot2 = scr_briefing(o2); image_index = 1;
	if(o_lvl34.o1) { obj1 = true; } if(o_lvl34.o2) { obj2 = true; } break;
	
	case r_lvl_35: t = 213; o1 = 216; o2 = 217; b = scr_briefing(t); ot1 = scr_briefing(o1); ot2 = scr_briefing(o2); image_index = 1;
	if(o_lvl35.o1 == true) { obj1 = true; }
	if(o_lvl35.o2 == true) { obj2 = true; }
	break;
	
	case r_lvl_36: t = 235; o1 = 238; o2 = 239; o3 = 240; b = scr_briefing(t); ot1 = scr_briefing(o1); ot2 = scr_briefing(o2); ot3 = scr_briefing(o3); image_index = 2;
	if(o_lvl36.o1) { obj1 = true; } 
	if(o_lvl36.o2) { obj2 = true; } 
	if(o_lvl36.o3) { obj3 = true; } 
	break;
	
	case r_lvl_37: t = 260; o1 = 225; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl37.o1) { obj1 = true; } break
	
	case r_lvl_38: t = 249; o1 = 252; o2 = 253; o3 = 254; o4 = 255; b = scr_briefing(t); ot1 = scr_briefing(o1); ot2 = scr_briefing(o2); ot3 = scr_briefing(o3); ot4 = scr_briefing(o4);
	image_index = 3;
	if(o_lvl38.o1) { obj1 = true; } 
	if(o_lvl38.o2) { obj2 = true; } 
	if(o_lvl38.o3) { obj3 = true; } 
	...
	case r_lvl_41: t = 218; o1 = 221; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl41.o1) { obj1 = true; } break;
	
	case r_lvl_42: t = 241; o1 = 244; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl42.o1) { obj1 = true; } break;
	
	case r_lvl_43: t = 181; o1 = 184; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl43.o1) { obj1 = true; } break;
	
	case r_lvl_44: t = 199; o1 = 202; o2 = 203; o3 = 204; b = scr_briefing(t); ot1 = scr_briefing(o1); ot2 = scr_briefing(o2); ot3 = scr_briefing(o3); image_index = 2;
	if(o_lvl44.o1) { obj1 = true; } 
	if(o_lvl44.o2) { obj2 = true; } 
	if(o_lvl44.o3) { obj3 = true; } 
	break;
	...
	case r_lvl_46: t = 226; o1 = 229; b = scr_briefing(t); ot1 = scr_briefing(o1); o2 = 230; ot2 = scr_briefing(o2); image_index = 1; 
	if(o_lvl46.o1) { obj1 = true; } 
	if(o_lvl46.o2) { obj2 = true; } break;
	
	case r_lvl_47: t = 205; o1 = 208; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl47.o1 == true) { obj1 = true; }
	break;
	
	case r_lvl_48: t = 231; o1 = 234; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl48.o1 == true) { obj1 = true; }
	break;
	
	case r_lvl_49: t = 256; o1 = 259; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl49.o1 == true) { obj1 = true; }
	break;
	
	case r_lvl_50: t = 209; o1 = 212; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl50.o1 == true) { obj1 = true; }
	break;
	
	case r_lvl_51: image_index = 9;
	break;
}