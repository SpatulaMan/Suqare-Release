...
switch(room)
{
	...
	image_index = 3; if(o_lvl21.accPoints >= 120) { obj1 = true; } if(o_lvl21.spdPoints >= 165) { obj2 = true; } if(o_lvl21.evPoints >= 90) { obj3 = true; }
	...
	case r_lvl_31: t = 164; o1 = 167; b = scr_briefing(t); ot1 = scr_briefing(o1); image_index = 0;
	if(o_lvl26.o1) { obj1 = true; } break;
}