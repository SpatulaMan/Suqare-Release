...
switch(room)
{
	...
	case r_lvl_25: draw_sprite_ext(s_lvl25map,0,w*.133,h*.055,1,1,0,c_white,1); break;//too tall
	case r_lvl_26: draw_sprite_ext(s_lvl25map,0,w*.133,h*.055,1,1,0,c_white,1); break;//too tall
	...
	case r_lvl_39: draw_sprite_ext(s_lvl39map,0,w*.25,h*.07,1,1,0,c_white,1); break;//too tall and narrow
	case r_lvl_43: draw_sprite_ext(s_lvl43map,0,w*.133,h*.055,1,1,0,c_white,1); break;//too tall
	case r_lvl_48: draw_sprite_ext(s_lvl48map,0,w*.133,h*.12,1,1,0,c_white,1); break;
	case r_lvl_49: draw_sprite_ext(s_lvl49map,0,w*.133,h*.055,1,1,0,c_white,1); break;
