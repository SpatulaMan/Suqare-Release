//Show/not show recap
if(!instance_exists(o_convo) and place_meeting(x,y,obj_suq) and check == false and h != 77)
{
	inst = instance_create(x,y,o_convo);
	inst.i = h;
	check = true;
}
else if((obj_suq.pistolHave == true and obj_suq.magnumHave == true or obj_suq.machineGunHave == true
	...
	and h == 77 and !instance_exists(o_convo) and place_meeting(x,y,obj_suq))
{
	inst = instance_create(x,y,o_convo);
	inst.i = h;
	check = true;
