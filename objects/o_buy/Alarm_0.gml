...
if(instance_exists(o_shop) and image_index != 2)
{
	switch(item)
	{
		...
		case 6: if(obj_suq.progress > 1) { image_index = 0; } else { image_index = 2; } break;
		case 7: image_index = 0; break;
		case 8: image_index = 0; break;
		case 9: if(obj_suq.progress > 1) { image_index = 0; } else { image_index = 2; } break;
		case 10: if(obj_suq.progress > 1) { image_index = 0; } else { image_index = 2; } break;
		...
		case 20: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 21: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 22: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 23: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 24: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 25: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 26: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 27: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 44: if(obj_suq.progress > 5) { image_index = 0; } else { image_index = 2; } break;
		case 43: if(obj_suq.progress > 3) { image_index = 0; } else { image_index = 2; } break;
