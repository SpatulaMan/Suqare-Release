...
if(image_index != 2)
{
	switch(item)
	{
		...
		case 32: if(image_index != 2) { draw_sprite_ext(s_turretT,0,x+25,y+4,1,1,0,c_white,1); } break;//change
		...
		case 30: if(image_index != 2) { draw_sprite_ext(s_turretF,0,x+25,y+4,1,1,0,c_white,1); } break;
		case 31: if(image_index != 2) { draw_sprite_ext(s_turretR,0,x+25,y+4,1,1,0,c_white,1); } break;
