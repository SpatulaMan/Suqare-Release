...
if(instance_exists(o_lvlStart))
{
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_2 or o_lvlStart.r == r_lvl_16 or o_lvlStart.r == r_lvl_28) and mCheck == true)
	{
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_3 or o_lvlStart.r == r_lvl_9 or o_lvlStart.r == r_lvl_15 or o_lvlStart.r == r_lvl_21 or o_lvlStart.r == r_lvl_27 or
	o_lvlStart.r == r_lvl_39) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_5 or o_lvlStart.r == r_lvl_11 or o_lvlStart.r == r_lvl_18 or o_lvlStart.r == r_lvl_19 or o_lvlStart.r == r_lvl_22 or
		o_lvlStart.r == r_lvl_24 or o_lvlStart.r == r_lvl_25 or o_lvlStart.r == r_lvl_26 or o_lvlStart.r == r_lvl_29 or o_lvlStart.r == r_lvl_43/* or o_lvlStart.r == r_lvl_32*/) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_6 or o_lvlStart.r == r_lvl_23) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_7 or o_lvlStart.r == r_lvl_8 or o_lvlStart.r == r_lvl_12 or o_lvlStart.r == r_lvl_13 or o_lvlStart.r == r_lvl_14 or 
	o_lvlStart.r == r_lvl_17 or o_lvlStart.r == r_lvl_30 or o_lvlStart.r == r_lvl_31) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_20 or o_lvlStart.r == r_lvl_33) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
...
if(room == r_lvl_2 or room == r_lvl_28)
{
...
if(room == r_lvl_3 or room == r_lvl_9 or room == r_lvl_15 or room == r_lvl_21 or room == r_lvl_27 or room == r_lvl_39)
{
	//audio_sound_gain(s1,0,3000);
	if(mCheck2 == false and mCheck3 == false)
	{
...
if(room == r_lvl_5 or room == r_lvl_22 or room == r_lvl_24 or room == r_lvl_25 or room == r_lvl_26 or room == r_lvl_29 or room == r_lvl_19 or room == r_lvl_31)
{
	if(mCheck2 == false and mCheck3 == false)
	{
		mCheck2 = true;
...
if(room == r_lvl_6 or room == r_lvl_23)
{
	//audio_sound_gain(s1,0,3000);
	if(mCheck2 == false and mCheck3 == false)
	{
...
{
	//audio_sound_gain(s1,0,3000);
	if(mCheck2 == false and instance_exists(obj_guard))
	{
		mCheck2 = true;
		audio_resume_sound(s1);
		audio_sound_gain(s1,.25*o_saveload.musvol,1000);
...
if(room == r_lvl_33 and instance_exists(o_eyeB))
{
	if(mCheck2 == false)
	{
		mCheck2 = true;
