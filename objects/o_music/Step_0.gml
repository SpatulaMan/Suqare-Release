...
if(instance_exists(o_lvlStart))
{
	...
	o_lvlStart.r == r_lvl_39 or o_lvlStart.r == r_lvl_45) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_5 or o_lvlStart.r == r_lvl_11 or o_lvlStart.r == r_lvl_18 or o_lvlStart.r == r_lvl_19 or o_lvlStart.r == r_lvl_22 or
		o_lvlStart.r == r_lvl_24 or o_lvlStart.r == r_lvl_25 or o_lvlStart.r == r_lvl_26 or o_lvlStart.r == r_lvl_29 or o_lvlStart.r == r_lvl_43 or o_lvlStart.r == r_lvl_34) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_6 or o_lvlStart.r == r_lvl_23 or o_lvlStart.r == r_lvl_44) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
...
if(room == r_lvl_5 or room == r_lvl_22 or room == r_lvl_24 or room == r_lvl_25 or room == r_lvl_26 or room == r_lvl_29 or room == r_lvl_19 or room == r_lvl_31 or room == r_lvl_19)
{
	if(mCheck2 == false and mCheck3 == false)
	{
		mCheck2 = true;
