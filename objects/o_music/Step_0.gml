...
if(instance_exists(o_lvlStart))
{
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_3 or o_lvlStart.r == r_lvl_9 or o_lvlStart.r == r_lvl_15 or o_lvlStart.r == r_lvl_21) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_5 or o_lvlStart.r == r_lvl_11 or o_lvlStart.r == r_lvl_18 or o_lvlStart.r == r_lvl_19 or o_lvlStart.r == r_lvl_22) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
...
if(room == r_lvl_3 or room == r_lvl_9 or room == r_lvl_15 or room == r_lvl_21)
{
	//audio_sound_gain(s1,0,3000);
	if(mCheck2 == false and mCheck3 == false)
	{
...
if(room == r_lvl_5 or room == r_lvl_22)
{
	if(mCheck2 == false and mCheck3 == false)
	{
		mCheck2 = true;
