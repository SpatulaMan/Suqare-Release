...
if(instance_exists(o_lvlStart))
{
	...
	if(o_lvlStart.speed > 0 and (o_lvlStart.r == r_lvl_7 or o_lvlStart.r == r_lvl_8 or o_lvlStart.r == r_lvl_12 or o_lvlStart.r == r_lvl_13 or o_lvlStart.r == r_lvl_14) and mCheck == true)
	{
		//if(audio_is_playing(s2))
		//{
			//audio_stop_sound(snd_mainTheme);
