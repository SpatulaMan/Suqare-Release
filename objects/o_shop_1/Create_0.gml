...
switch(prog)
{
	...
	case 5: if(wp[39] == false) { array_insert(item,t,39); t++; }//ammo bag upgrade
	case 4:
	case 3:
	case 2: if(wp[15] == false) { array_insert(item,t,15); t++; }//gunMax On Buy, delete previous and insert this into array
