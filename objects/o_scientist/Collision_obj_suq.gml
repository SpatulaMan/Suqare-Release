...
if(room == r_lvl_13)
{
	if(spawnCheck == false) 
	{
		instance_create_layer(2932,380,"Instances_Action",obj_ghostG);
		instance_create_layer(1770,403,"Instances_Action",obj_ghostG);
		instance_create_layer(1801,1128,"Instances_Action",obj_ghostG);
		instance_create_layer(677,401,"Instances_Action",obj_ghostG);
