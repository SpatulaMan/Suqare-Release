if(path_check and instance_exists(follow))
{
	if(mp_grid_path(global.grid,path,x,y,follow.x,follow.y,true))
	{
		path_start(path,.9,path_action_stop,false);
	}
}
