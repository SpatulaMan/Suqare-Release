if(num == 0) then { scr_barrel(); }
else if(num < 0) then { scr_barrelmoney(); }
else if(num > 0) then { scr_spiderspawn(); }//need to write this
audio_play_sound(snd_boxExplode,3,false,0.35*o_saveload.sfxvol,0,random_range(.4,1));
randomize();
var _p1 = instance_create(x,y,o_pieces);
_p1.sprite_index = s_box_B_pieces;
_p1.image_index = 0;
...
_p2.sprite_index = s_box_B_pieces;
_p2.image_index = 1;
...
_p3.sprite_index = s_box_B_pieces;
_p3.image_index = 2;
...
_p4.sprite_index = s_box_B_pieces;
_p4.image_index = 3;
...
_p5.sprite_index = s_box_B_pieces;
_p5.image_index = 4;
_p5.direction = choose(330,30,300,60,270,90,240,120,210,150,180);
_p5.speed = choose(2,3,4,5);

var _p6 = instance_create(x,y,o_pieces);
_p6.sprite_index = s_box_B_pieces;
_p6.image_index = 5;
_p6.direction = choose(330,30,300,60,270,90,240,120,210,150,180);
_p6.speed = choose(2,3,4,5);