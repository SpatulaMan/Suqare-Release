...
switch(mode)
{
	case 1: l1.image_angle = image_angle; 
			if(action == 1 and image_angle < rotMax) { image_angle++; } 
			if(action == 2 and image_angle > rotMin) { image_angle--; } 
	...
	case 3: image_angle++; l1.image_angle = image_angle; l2.image_angle = image_angle+90; 
			l3.image_angle = image_angle+180; l4.image_angle = image_angle+270; //Free spinning
