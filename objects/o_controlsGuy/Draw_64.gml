...
/*if(d)
{
	...
	draw_text_transformed_colour(roomw/2,roomh*.22,string_hash_to_newline(string(loading(l))),2,2,0,make_color_rgb(255,150,0),make_color_rgb(255,150,0),make_color_rgb(255,150,0),make_color_rgb(255,150,0),a);
